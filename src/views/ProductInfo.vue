                ...
                <div>
                  ...
                  <div class="image-carousel">
                    <div class="image-carousel-container">
                      <div class="image-holder">
                        <img
                          ...
                          v-show="productInfo.images[0]"
                          alt=""
                        />
                      </div>
                      <div
                        class="image-ctrl-wrap image-ctrl-wrap--l"
                        data-action="prev"
                        @click="prevImage"
                      >
                        ...
                        >
                          <g fill="none" fill-rule="evenodd">
                            ...
                            <path
                              fill="#29242D"
                              d="M7.787 11.707L2.08 5.999 7.787.293l1.414 1.414-4.293 4.292 4.293 4.294z"
                            ></path>
                          </g>
                        </svg>
                      </div>
                      <div
                        class="image-ctrl-wrap image-ctrl-wrap--r"
                        data-action="next"
                        @click="nextImage"
                      >
                        <span class="arrow"></span>
                    ...
                    <div class="image-carousel-pagination my-3">
                      ...
                      <div
                        class="overflow-scroll scroll-container-no-scrollbar"
                      >
                        <ul>
                          <!-- <li>
                  ...
                  <div data-purchase-box class="">
                    <div data-purchase-box-region="price" class="mb-2">
                      <div class="d-flex">
                        <div class="align-items-center">
                          <p
                            class="mytext-title-l me-3"
                            aria-label="final price"
                          >
                            {{ productInfo.currency }}${{ productInfo.price }}
                          </p>
                          <p
                            class="mytext-caption text-decoration-line-through"
                    ...
                    <div data-purchase-box-region="variation" class="mb-3">
                      <div class="mb-3">
                        <div class="mb-2">
                          <label
                            class="mytext-caption"
                            for="inventory-variation-select-0"
                            >Size</label
                          >
                        ...
                        <div class="mb-2">
                          <label
                            class="mytext-caption"
                            for="inventory-variation-select-1"
                            >Option</label
                          >
                          <div class="myselect-container">
                            <select
                              name=""
                              id="inventory-variation-select-1"
                              class="select-element"
                            >
                              <option value="" selected>
                                Select an option
...
export default {
  ...
  setup(props) {
    ...
    async function fetchProductsByAlias(alias) {
      const result = await fetch(`${shopAPI}?searchby=alias&value=${alias}`, {
    ...
    fetchProductsByAlias(props.productAlias).then(() => {
      isLoaded.value = true;
    });
    ...
    const nextImage = () => {
      if (activeImageIndex.value < productInfo.value.images.length - 1) { activeImageIndex.value += 1; } else activeImageIndex.value = 0;
    };
    const prevImage = () => {
