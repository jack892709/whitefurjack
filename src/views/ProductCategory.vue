        ...
        <div class="mt-2 px-2 px-md-4">
          ...
          >
            <ol class="breadcrumb m-0">
              ...
              <li class="breadcrumb-item ">
                <router-link
                  :to="`/shop/${currentCategory}`"
                  class="text-capitalize"
                >{{currentCategory}}</router-link>
              </li>
            ...
            <div class="filter-width ps-3">
              <div class=" sticky-top top-15 px-2">
                ...
                >
                  ...
                  >
                    <legend>
                      <h3 class="text-caption-title text-capitalize mb-0">
                        Special Offers
                      </h3>
                    </legend>
                    <div>
                      <div class="ps-2 mb-2 d-flex align-items-center">
                        <div class="checkbox">
                          <input
                            type="checkbox"
                            name="free_shipping"
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        ...
                        <span class="text-skinny-s ps-2">Show more</span>
                      </button>
                      <button
                        class="filter-expander btn-basic rounded-pill"
                        type="button"
                      ...
                      >
                        ...
                        <span class="text-skinny-s ps-2">Show fewer</span>
                      </button>
                    </div>
                  </fieldset>
                </form>
              ...
              >
                <div class="container-fluid px-0">
                  <ul class="row list-unstyled m-0">
                    ...
                    <li
                      class="col-4 d-block p-2 listing-card"
                    ...
                    >
                      ...
                      >
                        ...
                        <div class="pt-1 info">
                          <h3
                            class="listing-card-title text-truncate m-0"
                            :title="item.title"
                          >{{item.title}}</h3>
                          <div>
