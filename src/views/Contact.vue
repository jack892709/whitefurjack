            ...
            <div class="info-layout">
                <div class="contact-block">
                    <div class="page-header mb-4">
                        <h1>Contact</h1>
                        <div>Please get in touch and say hello, I’d love to hear from you</div>
                    </div>
                    <div class="form-fields">
                        <div class="form-item mb-4">
                            <input type="text" v-model="fields.name" name="name" id="name" class="myform-control text-field" placeholder="Your Name">
                            <div class="error-validation">{{errorMsg.name}}</div>
                        </div>
                        <div class="form-item mb-4">
                            <input type="text" v-model="fields.email" name="email" id="email" class="myform-control text-field" placeholder="Your E-mail">
                            <div class="error-validation">{{errorMsg.email}}</div>
                        </div>
                        <div class="form-item mb-4">
                            <textarea v-model="fields.message" name="message" id="message" cols="30" rows="7" class="myform-control textarea-field" placeholder="Your Message" style="margin-top: 0px; margin-bottom: 0px; height: 240px;"></textarea>
...
export default {
    ...
    methods: {
        ...
        checkValidation() {
            ...
            if (!this.fields.message) this.errorMsg.message = 'This field should not be blank.';
