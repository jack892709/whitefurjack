<template>
    ...
    <div class="cart-popup" :class="{active: isActive}">
        <div class="curtain"
            @click="closeCart"
        >
        ...
        <div class="minicart">
            ...
            <header class="d-flex p-2">
                <div id="closeCartButton" class="btn-right p-2"
                    @click="closeCart"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 12 12" data-v-220f4773=""><g fill="none" fill-rule="evenodd" data-v-220f4773=""><path d="M0 0h12v12H0z" data-v-220f4773=""></path><path fill="#29242D" d="M4.214 11.707L2.8 10.293l4.293-4.294L2.8 1.707 4.214.293l5.707 5.706z" data-v-220f4773=""></path></g></svg>
                </div>
            ...
            <section class="px-2 flex-grow-1 overflow-scroll scroll-container-no-scrollbar">
                <div class="h-100 d-flex justify-content-center align-items-center" v-if="!tobuyCount">
                    <span>Your cart is empty.</span>
                </div>
                <div class="cart-container" v-show="tobuyCount">
                            ...
                            <div class="cart-item-quantity">
                                <div class="cart-control">
                                    <div class="cart-input-group mytext-body">
                                        ...
                                        <input type="text" class="myform-control" :value="item.quantity" disabled @change="updateTobuyQuantity">
            ...
            <section class="px-3 py-2 text-end" v-if="tobuySubtotal">
                <span class="me-2 mytext">Subtotal</span>
                <span class="fw-bold">NT${{tobuySubtotal}}</span>
            </section>
            <footer class="p-3">
                <router-link to="/cart" class="mybtn w-100 btn-dark">
                    <div>View Cart</div>
                </router-link>
            </footer>
        </div>
    </div>
    <div class="cart-bar fixed-bottom d-lg-none" v-if="tobuyCount">
        <router-link to="/cart" class="d-flex p-2">
