<template>
    ...
    <CartPopup :is-cart-active="isCartActive" @closeCart="isCartActive=false" />
    <!-- <header> -->
        <div class="nav-mobile d-lg-none" v-show="isMenuActive">
        ...
        <div class="nav-desktop" :class="{ 'bg-transparent': isMenuActive }">
                ...
                <div class="d-flex justify-content-start align-items-center">
                        ...
                        <ul class="mynavbar d-none d-lg-flex">
                            ...
                            <li class="nav-desktop-item">
                                ...
                                <div class="nav-hover-menu">
                                    <ul
                                        class="nav-dropdown-list bg-white shadow"
                                    >
                            ...
                            <li class="nav-desktop-item">
                                <router-link to="/shop" class="nav-desktop-link"
                    ...
                    <div class="d-none d-lg-flex ms-auto nav-desktop-iconbox">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="nav-desktop-icon icon-dark position-relative"
                            ...
                            >
                                ...
                                <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-custom" v-if="tobuyCount>0">
                                    {{tobuyCount}}
...
.fade-y {
    ...
    &::after {
        ...
        // background: -webkit-linear-gradient(bottom, #2f2f2f 10%, #2f2f2f 100%);
        // background: -o-linear-gradient(bottom, #2f2f2f 10%, #2f2f2f 100%);
        background: linear-gradient(to top, #2f2f2f 10%, transparent 16%, transparent 84%, #2f2f2f 90%);
    }
}
